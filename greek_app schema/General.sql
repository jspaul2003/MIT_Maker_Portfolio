...
--
-- Host: localhost
-- Generation Time: Jan 06, 2021 at 10:05 PM
...
INSERT INTO `EMPTY` (`CODE1`, `CODE2`, `GREEK`, `ENGLISH`, `ID`) VALUES
('', '', '', '', 1),
('', '', '', '', 2),
('', '', '', '', 3),
('', '', '', '', 4),
...
--
-- Table structure for table `presentation120200708153409`
--

CREATE TABLE `presentation120200708153409` (
  `CODE1` text,
  `CODE2` text,
  `GREEK` text,
  `ENGLISH` text,
...
--
-- Constraints for table `Junction1`
--
ALTER TABLE `Junction1`
